            ...
            <div class="row">
                ...
                <div class="text-center">
                    ...
                    if(isset($_POST['btnsubmit']))
                    {
                        ...
                        $obj->show_user_recipe($prepation_time,$cooking_time,$diffulty,$serve,$calories,$protiens,$carbs,$fat,$saturation,$fiber,$sugar,$salt,$recipies_pic,$recipe_title,$recipe_description,$user_name,$user_email,$submit_date,$user_id);
